...
* Digital cinema offers strong content protection which in turn allows for easy distribution. As opposed to film prints that are being accompanied by security personnel.
...
Basically an image sequence (the film) is encoded to a well-defined, cinema-specific JPEG 2000 codestream. Packed up (alongside with sound and subtitles) in MXF containers and composed through the means of descriptive XML to what will be shown on the screen. These _compositions_ are what make DCP such a powerful and flexible format. Final package gets copied onto harddrive, memory stick, optical medium, and ingested on a digital cinema server. Finally, someone hits _Play_.
