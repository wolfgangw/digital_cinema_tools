...
[[Cinemaslides]] has a lot of options to tweak its output. The less you specify the more it will fall back to defaults. So the above will default to be 5 seconds long, a bit short. Throw some more pictures into the mix and let it play a bit longer:

@cinemaslides --type dcp Happy_Birthday.wav Toddler_Madeleine.jpg First_Schoolday.jpg By_the_Sea.jpg Madeleine.jpg -x fade,1,10,1@

where @-x@ (or its long form @--transition-and-timing@) lets you specify how long each image will hold and how the transition between images will be made: @-x fade,1,10,2@ means fade in for 1 second, hold for 10 seconds, fade out for 2 seconds. Separate those numbers with comma (no spaces).

[[Cinemaslides]] handles options rather liberally: You can specify them in any order and many options can be specified in short or long form. See @cinemaslides --help@ (or @cinemaslides -h@ for that matter) for all the gory details.

[[Cinemaslides]] offers 3 basic transition types: Cut, fade in/out and crossfade.
